...
export function BottomBar() {
  ...
  return (
    <footer className="relative z-50 flex h-12 shrink-0 items-center justify-between gap-2 overflow-hidden border-t border-white/10 bg-cyber-bar px-2 text-white sm:px-3">

...
export const SidePanel = memo(function SidePanel({
  ...
  return (
    <div className="z-10 flex h-full w-[min(18rem,calc(100vw-56px))] shrink-0 flex-col overflow-hidden border-r border-white/10 bg-[var(--panel)] text-white shadow-panel animate-in slide-in-from-left-4 duration-200 md:w-80">
